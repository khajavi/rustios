//! rustios — the smallest possible kernel for learning.
//!
...
#![no_main]  // Kernels do not start in a `main` function; GRUB jumps straight
             // into our assembly entry point `_start` (see boot.s), which then
             // calls the `kmain` function at the bottom of this file.
